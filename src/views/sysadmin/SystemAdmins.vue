        ...
        <v-card class="pa-4">
          ...
          <v-form v-model="passwordFormValid" ref="editSysAdminPasswordForm">
            <v-container>
              ...
              <v-layout v-if="isCurrentUser" row fill-height align-center justify-center>
                ...
                <span class="text-warning headline font-weight-bold text-xs-center-xs ma-2">You are editing the user currently logged into the portal. If you successfully change the password you will be directed back to the log in screen</span>
              </v-layout>
              <v-card-title>
                <v-icon medium :color="primaryColor">{{ icon }}</v-icon>
                <span v-show="editFormVisible" class="title text-primary">Change System Administrator Password</span>
                <span v-show="newFormVisible" class="title text-primary">Set System Administrator Password</span>
              </v-card-title>
              <v-card-text>
                <v-text-field
                  class="ma-1"
          ...
          <v-form v-if="editFormVisible" v-model="editFormValid" ref="editSysAdminDetailsForm">
            <v-container>
              <v-card-title>
                <v-icon medium :color="primaryColor">{{ icon }}</v-icon>
                <span class="title text-primary">Change System Admin Details</span>
                <v-spacer />
          ...
          <v-form v-if="newFormVisible" v-model="newFormValid" ref="newSysAdminDetailsForm">
            <v-container>
              <v-card-title>
                <v-icon medium :color="primaryColor">{{ icon }}</v-icon>
                <span class="title text-primary">Add new System Administrator</span>
              </v-card-title>
              <v-card-text>
                <v-text-field
                  class="ma-1"
